...
function applyFiltersWk() {
    ...
    for (var i = 0; i < workouts.length; i++) {
        ...
        var txtziel = workout.querySelector('.module-attribut-border-three:nth-child(1)').innerText.toUpperCase();
        var txtbody = workout.querySelector('.module-attribut-border-three:nth-child(2)').innerText.toUpperCase();
        var txtequipment = workout.querySelector('.module-attribut-border-three:nth-child(3)').innerText.toUpperCase();
